...
public final class RuntimeTestFixtures {
    ...
    public static GameSetup classicSetup(int playerCount, long seed) {
        return new GameSetup(
                ...
                classicRuleSet(playerCount),
                "classic-" + playerCount + "p-v2",
                classicSetupTemplate(playerCount),
                seed,
    ...
    public static RuleSetDefinition classicRuleSet() {
        return classicRuleSet(5);
    }

    public static RuleSetDefinition classicRuleSet(int playerCount) {
    ...
    public static SetupTemplate classicSetupTemplate() {
        return classicSetupTemplate(5);
    }

    public static SetupTemplate classicSetupTemplate(int playerCount) {
